...
// General parameters
ESSENTIAL_PROJECT="/fsimb/groups/imb-bioinfocf/projects/schick/imb_schick_2020_01_schick_chromatin_modeler_in_silico/recounts/kaessmann_devstage/"   // full project directory path
...
ESSENTIAL_STAR_REF="/fsimb/common/genomes/homo_sapiens/gencode/release-26_GRCh38.p10/full/index/star/2.7.3a/"     // directory containing all STAR index files
ESSENTIAL_GENESGTF="/fsimb/common/genomes/homo_sapiens/gencode/release-26_GRCh38.p10/full/annotation/gencode.v26.collapsed_annotation_gtex.gtf"  // properly formatted gene annotation GTF file having *different* gene and trancript IDs (e.g. from Ensembl or Gencode); If you use Gencode here, please remember to edit the gtf module variables in the rmats.header file
ESSENTIAL_GENESBED="/fsimb/common/genomes/homo_sapiens/gencode/release-26_GRCh38.p10/full/annotation/gencode.v26.collapsed_annotation_gtex.bed"  // gene annotation BED file 
ESSENTIAL_CHROMSIZES="/fsimb/common/genomes/homo_sapiens/gencode/release-26_GRCh38.p10/full/index/star/2.7.3a/chrNameLength.txt" // chromosome sizes file
...
ESSENTIAL_READLENGTH=100         // read length - used for optimal mapping over splice-junctions
ESSENTIAL_STRANDED="no"    // library prep protocol strandness: no|yes|reverse
ESSENTIAL_ORG="human"           // UCSC organism name (human, mouse, fly, worm, yeast, zebrafish)
